...
public class CryptoUtils {
  ...
  public static void main(String[] args) throws Exception {
    final String KEY_FILE = "/home/daniel/howto.key";
    final String PWD_FILE = "/home/daniel/howto.properties";

    String clearPwd= "daniel2";
    String clearPwd2= "daniel3";
    ...
    p3.load(new FileReader(PWD_FILE));
    encryptedPwd = p3.getProperty("pwd");
